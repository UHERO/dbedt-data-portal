...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_rxjs_Rx__ = __webpack_require__(751);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_rxjs_Rx___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_rxjs_Rx__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_rxjs_add_operator_mergeMap__ = __webpack_require__(394);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__api_service__ = __webpack_require__(237);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_angular2_tree_component__ = __webpack_require__(350);
...
var HelperService = (function () {
    ...
    HelperService.prototype.formatLevelData = function (seriesObservations, newObservations, frequency, decimals, results, dates) {
        var _this = this;
        var obs = seriesObservations;
        var newObs = newObservations;
        var level = newObs ? newObservations : obs.transformationResults.find(function (transforms) { return transforms.transformation === 'lvl'; }).observations;
        if (level) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__api_service__ = __webpack_require__(237);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__helper_service__ = __webpack_require__(348);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__category_sidebar_category_sidebar_component__ = __webpack_require__(347);
...
var AppComponent = (function () {
    ...
    AppComponent.prototype.getSeries = function () {
        ...
        this.selectedIndicators.forEach(function (indicatorSeries, indIndex) {
            ...
            var newIndicatorLevel = indicatorSeries.seriesObservations.transformationResults.find(function (transforms) { return transforms.transformation === 'lvl'; });
            var levelValues = indicatorLevel ? indicatorLevel.observations : newIndicatorLevel.values;
            var geoSelected = _this.selectedGeos.findIndex(function (geo) { return geo === indicatorGeo; });
            var freqSelected = _this.selectedFreqs.findIndex(function (freq) { return freq === indicatorFreq; });
            ...
            if (geoSelected > -1 && freqSelected > -1 && levelValues !== null) {
                if (newIndicatorLevel.dates && newIndicatorLevel.values) {
                    indicatorSeries.observations = _this.formatObservations(newIndicatorLevel);
                }
    ...
    AppComponent.prototype.formatObservations = function (indicatorLevel) {
        // Return array of of dates with their corresponding values
        var dates = indicatorLevel.dates;
        var values = indicatorLevel.values;
        var formattedResults = dates.map(function (d, index) {
            var entry = { date: '', value: '' };
            entry.date = d;
        ...
        seriesData.forEach(function (series) {
            ...
            if (exist !== -1) {
                if (series.frequencyShort === 'A') {
                    _this._helper.formatLevelData(series.seriesObservations, series.observations, series.frequencyShort, decimals, _this.tableData[exist].observations, _this.dateArray);
                }
                ...
                _this.tableData.push({
                    ...
                    observations: _this._helper.formatLevelData(series.seriesObservations, series.observations, series.frequencyShort, decimals, result, _this.dateArray)
                });
            }
        });
    };
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_platform_browser__ = __webpack_require__(229);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__(1);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__api_service__ = __webpack_require__(237);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__helper_service__ = __webpack_require__(348);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__app_component__ = __webpack_require__(544);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__category_sidebar_category_sidebar_component__ = __webpack_require__(347);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_angular2_tree_component__ = __webpack_require__(350);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__geo_selector_geo_selector_component__ = __webpack_require__(547);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__freq_selector_freq_selector_component__ = __webpack_require__(546);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__year_selector_year_selector_component__ = __webpack_require__(551);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__quarter_selector_quarter_selector_component__ = __webpack_require__(550);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__month_selector_month_selector_component__ = __webpack_require__(549);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__indicator_table_indicator_table_component__ = __webpack_require__(548);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_jquery__ = __webpack_require__(68);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_datatables_net__ = __webpack_require__(92);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_datatables_net_fixedcolumns__ = __webpack_require__(724);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_datatables_net_buttons_js_dataTables_buttons_js__ = __webpack_require__(174);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_datatables_net_buttons_js_buttons_html5_js__ = __webpack_require__(722);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_datatables_net_buttons_js_buttons_flash_js__ = __webpack_require__(721);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_datatables_net_buttons_js_buttons_print_js__ = __webpack_require__(723);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_datatables_net_buttons_js_buttons_print_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7_datatables_net_buttons_js_buttons_print_js__);
...
var IndicatorTableComponent = (function () {
    ...
    IndicatorTableComponent.prototype.initDatatable = function () {
        var tableColumns = [];
        var indicatorTable = __WEBPACK_IMPORTED_MODULE_1_jquery__('#indicator-table');
        if (this.tableWidget) {
            ...
            buttons: [
                {
                    ...
                    customize: function (xlsx) {
                        ...
                        var col = __WEBPACK_IMPORTED_MODULE_1_jquery__('col', sheet);
                        var textCells = __WEBPACK_IMPORTED_MODULE_1_jquery__('sheetData c is', sheet);
                        var rows = __WEBPACK_IMPORTED_MODULE_1_jquery__('sheetData row', sheet);
                        var dates = __WEBPACK_IMPORTED_MODULE_1_jquery__('v', rows[0]);
                        // Right align dates in first row
                        dates.each(function () {
                            __WEBPACK_IMPORTED_MODULE_1_jquery__(this.parentElement).attr('s', 52);
                        });
                        // Right align cells with text, except footer
                        var i = 0;
                        while (i < textCells.length - 1) {
                            __WEBPACK_IMPORTED_MODULE_1_jquery__(textCells[i].parentElement).attr('s', 52);
                            i++;
                        }
                    }
                },
                ...
                },
                {
                    ...
                    customize: function (win) {
                        ...
                        // Original table
                        var dtTable = __WEBPACK_IMPORTED_MODULE_1_jquery__(win.document.body).find('table');
                        newTables.forEach(function (table) {
                            __WEBPACK_IMPORTED_MODULE_1_jquery__(win.document.body).append('<br>');
                            __WEBPACK_IMPORTED_MODULE_1_jquery__(win.document.body).append(table);
                        });
                        // Remove original table from print
                        dtTable.remove();
                        var $tables = __WEBPACK_IMPORTED_MODULE_1_jquery__(win.document.body).find('table');
                        $tables.each(function (i, table) {
                            __WEBPACK_IMPORTED_MODULE_1_jquery__(table).find('tr:odd').each(function () {
                                __WEBPACK_IMPORTED_MODULE_1_jquery__(this).css('background-color', '#F9F9F9');
                            });
                            __WEBPACK_IMPORTED_MODULE_1_jquery__(table).find('td').each(function () {
                                __WEBPACK_IMPORTED_MODULE_1_jquery__(this).css('text-align', 'right');
                                __WEBPACK_IMPORTED_MODULE_1_jquery__(this).css('width', '10%');
                            });
                        });
                        __WEBPACK_IMPORTED_MODULE_1_jquery__(win.document.body)
                            .find('br:last-child')
        ...
        __WEBPACK_IMPORTED_MODULE_1_jquery__('span.loading').css('display', 'none');
    };
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["w" /* Input */])(), 
        __metadata('design:type', Object)
